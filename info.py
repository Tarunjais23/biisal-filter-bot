...
#main variables
API_ID = int(environ.get('API_ID', '24963403'))
API_HASH = environ.get('API_HASH', '417405c7c9b7cf3db12e31f3bfebdc3f')
BOT_TOKEN = environ.get('BOT_TOKEN', '7423493503:AAG-sMfQeZn49VNZOJNF-gQP3j6GVjDWfas')

ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '24963403').split()]
USERNAME = environ.get('USERNAME', "https://telegram.me/biisal")
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002009145832'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/tjmovies07')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002047519334').split()]
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://tarun234:tarun234@cluster0.v3n2umt.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002104815458'))
request_channel = environ.get('REQUEST_CHANNEL', '1002047519334').split()
REQUEST_CHANNEL = int(request_channel) if request_channel and id_pattern.search(request_channel) else None
UPI_PAY_LOGS = int(environ.get('UPI_PAY_LOGS', '-1008000054678'))
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1001955474435'))
